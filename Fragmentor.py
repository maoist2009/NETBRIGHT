...
def start_server():
    with open("config.json",'r', encoding='UTF-8') as f:
        global config,output_data,my_socket_timeout,listen_PORT,num_TCP_fragment,num_TLS_fragment,TCP_sleep,TCP_frag,TLS_frag,doh_server,domain_settings,DNS_log_every,domain_settings_tree
        config = json.load(f)
